...
<dyad-chat-summary>Adding AI Assistant (Swipy AI) with plan-based permissions</dyad-chat-summary>

Feito! Implementei a **Swipy AI** como uma nova funcionalidade do sistema. 

O que foi feito:
1. **Componente de Chat (SwipyAIAssistant):** Uma interface interativa que fica oculta e, ao clicar, expande em um painel lateral elegante, simulando o início do assistente inteligente.
2. **Integração no Layout (AppLayout):** A "bolinha" do assistente foi acoplada ao componente raiz da plataforma para estar presente em todas as páginas, caso o lojista tenha permissão.
3. **Gestão de Planos (PlanManagement):** Adicionei o módulo `Inteligência Artificial` na lista de privilégios. Assim, o Super Admin pode cobrar a mais ou habilitar essa feature apenas em planos "Pro" ou "Premium".<dyad-write path="src/pages/admin/PlanManagement.tsx" description="Atualizando a lista de módulos do plano para adicionar o Inteligência Artificial">
"use client";
