...
import { 
  ...
  ReceiptText, Layers, ArrowRightLeft, FileArchive, Share2
} from 'lucide-react';
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative w-full h-full">
        {activeMerchant && (
           <div className="bg-orange-500 px-6 py-2 flex items-center justify-between z-[60] shrink-0">
              ...
              <button onClick={() => { setActiveMerchant(null); navigate('/contador'); }} className="text-white text-[9px] font-black underline bg-white/10 px-2 py-1 rounded-md">ENCERRAR</button>
           </div>
        )}
        ...
        <header className="h-16 border-b border-apple-border flex items-center justify-between px-4 md:px-8 bg-apple-white/80 backdrop-blur-md shrink-0 z-40">
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            <h1 className="text-xs font-black text-apple-black truncate uppercase tracking-widest">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 rounded-xl bg-apple-offWhite border border-apple-border overflow-hidden shadow-sm">
